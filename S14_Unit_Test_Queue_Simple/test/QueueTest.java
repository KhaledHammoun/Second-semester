...
class QueueTest
{
  private QueueADT queueEmpty;
  private QueueADT queueWithElements;


  @BeforeEach
  public void setup()
  {
    queueEmpty = new SimpleBoundedArrayQueueC(4);
    queueWithElements = new SimpleBoundedArrayQueueC(4);
    queueWithElements.enqueue("1");
    queueWithElements.enqueue("2");
    queueWithElements.enqueue("3");
  }

  @Test public void constructorZeroElementsTestCorrect()
  {
  ...
  @Test public void constructorNegativeValue()
  {
    ...
    assertThrows(IllegalArgumentException.class,
        () -> queueEmpty = new SimpleBoundedArrayQueueCorrect(-1));
  }
